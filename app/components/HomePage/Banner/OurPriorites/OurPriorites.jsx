  ...
  return (
    <div className='my-10 mx-32'>
      ...
      <div className='grid grid-cols-3 gap-5 my-10'>
        <div className='relative w-72 flex flex-col justify-center items-center'>
        ...
        <div className='relative w-72 flex flex-col justify-center items-center'>
          <img className='w-full h-52' src={img2} alt="" />
          <div className='absolute bottom-0 bg-[#000000b4] p-3'>
        ...
        <div className='relative w-72 flex flex-col justify-center items-center'>
          <img className='w-full h-52' src={img4} alt="" />
          <div className='absolute bottom-0 bg-[#000000b4] p-3 '>
            <h1 className='text-white'>Clean Water & Air Initiative</h1>
          </div>
        </div>
        <div className='relative w-72 flex flex-col justify-center items-center'>
          <img className='w-full h-52' src={img5} alt="" />
          <div className='absolute bottom-0 bg-[#000000b4] p-3 '>
